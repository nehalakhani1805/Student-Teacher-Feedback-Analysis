...
urlpatterns = [
    ...
    path('mystudentreport/',courses_views.mystudentreport,name='my-student-report'),
    ...
    path('subjectdetail/<int:sid>/myfeedback/<int:fid>/editdraft/',courses_views.editdraft,name='editdraft'),
    path('subjectdetail/<int:sid>/myfeedback/<int:fid>/formreport/',courses_views.formreport,name='formreport'),
    ...
    path('subjectdetail/<int:sid>/myfeedback/<int:fid>/editform/<int:fqid>/deletedraftquestion/',courses_views.deletedraftquestion,name='deletedraftquestion'),
    path('subjectdetail/<int:sid>/myfeedback/<int:fid>/editform/<int:fqid>/editdraftquestion/',courses_views.editdraftquestion,name='editdraftquestion'),
]
